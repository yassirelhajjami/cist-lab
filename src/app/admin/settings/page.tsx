...
import { Settings, Shield, Sliders, AlertCircle, Save } from 'lucide-react';
...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-6 text-xs font-semibold text-slate-700">
      ...
      <form onSubmit={handleSave} className="grid gap-6 lg:grid-cols-2 items-start">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-sm space-y-4">
          ...
          <div className="pt-6 border-t border-slate-150 flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className="flex items-center space-x-1.5 rounded-lg bg-navy-deep hover:bg-maple-red px-5 py-2.5 text-xs font-bold text-white shadow transition-all active:scale-95 disabled:opacity-50"
            >
